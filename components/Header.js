...
const Header = () => {
  return (
    <div className="sticky top-0 flex py-4 border-b shadow-md justify-between space-x-4 px-3 bg-white">
      ...
      <div className="flex space-x-5 items-center overflow-x-scroll  scrollbar-thin justify-between">
        {/* HomeIcon */}
        <div className="">
          <Link href="/">
        ...
        <div>
          <Link href="about">
            <img
              src="https://plus.unsplash.com/premium_photo-1667667720425-6972aff75f6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cHJvZmlsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60"
              alt=""
